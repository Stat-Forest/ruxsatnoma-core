...
The application aggregate, its state machine and SLA tracking. Status
transitions are defined in state_machine.py and nowhere else.

Owns the app database schema and touches no other module's tables,
